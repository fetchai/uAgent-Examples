...
class PaymentResponse(Model):
    ...
    generate_time: int = Field(description="Timestamp when the payment link was generated.")
    payment_status: str = Field(description="Current status of the payment.")
    confirmation_time: int = Field(description="Timestamp when the payment was confirmed.")
