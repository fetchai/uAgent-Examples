...
This agent uses OpenAI's `gpt-5.4-mini` LLM to translate a given text from one language into another language. If the input language is not provided, the AI model will be instructed to try to detect it.
