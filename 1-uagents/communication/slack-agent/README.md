...
To deploy Slack agent, copy and paste the following code into a new [Blank agent](https://agentverse.ai/agents/create/getting-started/blank-agent), make sure to include your slack token:
...
SLACK_TOKEN = "paste_your_slack_token"
