...
2. Load the environment variable manually using `os.getenv("AV_API_KEY")`. To get an API key please visit [ALPHAVANTAGE](https://www.alphavantage.co/).
